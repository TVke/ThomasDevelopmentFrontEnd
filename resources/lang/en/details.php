...
return [
    ...
    */
    ...
    /* functional */
    'lot-id' => 'Lot ID: :id',
    'article-title' => 'Dance of Time III',
    'bid-count' => 'bid|bids',
    'bid-count-reversed' => 'bid:|bids:',
    'time-left' => 'left',
    'more' => 'more',
    'estimated' => 'Estimated price:',
    'buy-now' => 'Buy now for :price',
    'bid' => 'BID NOW',
    'add-watchlist' => 'add to my watchlist',
    'ask-question' => 'ASK A QUESTION ABOUT THIS AUCTION',

    /* descriptions */
    'image-1' => 'Camera on a wooden table with a blurred background',
    'image-2' => 'Display of the camera with an image of a gym on the display',
    'image-3' => 'photograph taken with the camera of round window with a blurred street view',

    'description' => 'Description',
    'description-content' => '"Dance of Time III" (1979-84) is a stunning bronze and gold patina sculpture 
    ...
    'color' => 'Color',
    'color-content' => 'Bronze, patinated bronze and gold',
